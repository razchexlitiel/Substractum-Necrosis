...
public class DepthWormModel extends GeoModel<DepthWormEntity> {
    private static final ResourceLocation MODEL = new ResourceLocation(SubstractumMod.MOD_ID, "geo/depth_worm.geo.json");
    private static final ResourceLocation TEXTURE = new ResourceLocation(SubstractumMod.MOD_ID, "textures/entity/depth_worm.png");
    private static final ResourceLocation TEXTURE_ATTACK = new ResourceLocation(SubstractumMod.MOD_ID, "textures/entity/depth_worm_attack.png");
    private static final ResourceLocation ANIM = new ResourceLocation(SubstractumMod.MOD_ID, "animations/depth_worm.animation.json");
